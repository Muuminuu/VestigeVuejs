    ...
    <div class="game-view">
      <div class="game-header">
        <div class="header-info-container">
          ...
          <div class="header-info actions-info">
            <button class="menu-button" @click="returnToHome">Menu Principal</button>
          </div>
        </div>
      </div>
      ...
      <div class="game-content">
        ...
        <div class="game-main">
          <decorative-frame :theme="frameTheme" :level="frameMagicLevel">
            ...
            <combat-interface v-if="showCombat" @end-combat="endCombat" />
              
            <!-- Affichage du composant de vue actuel -->
            <component 
          ...
          <div class="action-buttons" v-if="!showCombat">
